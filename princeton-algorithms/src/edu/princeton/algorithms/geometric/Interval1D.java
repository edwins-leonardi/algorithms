package edu.princeton.algorithms.geometric;
...
public class Interval1D {
    ...
    private static class MinEndpointComparator implements
    ...
    private static class MaxEndpointComparator implements
            Comparator<Interval1D> {
        public int compare(Interval1D a, Interval1D b) {
            if (a.min < b.max)
                return -1;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i < intervals.length; i++) {
            ...
            StdOut.println(intervals[0].intersects(intervals[i]));
        }
